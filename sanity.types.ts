...
// Variable: AUTHOR_GITHUB_BY_ID
// Query: *[_type=='author' &&_id==$id][0]{  _id,name  ,image,bio,username, email, id ,bio}
export type AUTHOR_GITHUB_BY_IDResult = {
  _id: string;
  name: string | null;
  image: string | null;
  bio: string | null;
...
export type AUTHER_STARTUP_QUERYResult = Array<{
  _id: string;
  title: string | null;
  slug: Slug | null;
  _createdAt: string;
